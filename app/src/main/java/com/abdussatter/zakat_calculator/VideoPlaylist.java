...
public class VideoPlaylist extends YouTubeBaseActivity implements YouTubePlayer.OnInitializedListener {
    ...
    private void addVideos(){
        ...
        //Video No-01------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "n1LfAfKiAyA");
        hashMap.put("vdo_title", "যাকাত সম্পর্কিত গুরুত্বপূর্ণ মাসআলা ।");
        hashMap.put("vdo_desciption", "ড. মুযাফফর বিন মুহসিন");
        ...
        //Video No-02 ------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "vDzh0_Xu4N8");
        hashMap.put("vdo_title", "যাকাত সম্পর্কে গুরুত্বপূর্ণ প্রশ্ন ও উত্তর।যাকাত দেওয়ার নিয়ম ।");
        hashMap.put("vdo_desciption", "শায়খ আহমাদুল্লাহ");
        arrayList.add(hashMap);
        ...
        arrayList.add(hashMap);
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "cBoBjlbXYHo");
        hashMap.put("vdo_title", "যাকাত দেওয়ার নিয়ম ।");
        hashMap.put("vdo_desciption", "মিজানুর রহমান আজহারী");
        arrayList.add(hashMap);
        ...
        arrayList.add(hashMap);
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "TEEjg43HRBM");
        hashMap.put("vdo_title", "যাকাত সম্পর্কিত ৫০ টি গুরুত্বপূর্ণ প্রশ্নের উত্তর");
        hashMap.put("vdo_desciption", "শায়খ আহমাদুল্লাহ");
        arrayList.add(hashMap);
        ...
        arrayList.add(hashMap);
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "H5UfaVT9YTs");
        hashMap.put("vdo_title", "যাকাতের গুরুত্ব ও তাৎপর্য সম্পর্কে বিস্তারিত বক্তব্য");
        hashMap.put("vdo_desciption", "মিজানুর রহমান আজহারী");
        arrayList.add(hashMap);
        ...
        arrayList.add(hashMap);
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "wdCgRIXziLw");
        hashMap.put("vdo_title", "যাকাতের আটটি খাত কি কি | বিস্তারিত শুনুন");
        hashMap.put("vdo_desciption", "মিজানুর রহমান আজহারী");
        arrayList.add(hashMap);
        ...
        //Video No-08 -------------->>>>>>>>>>>>>>>>>
        hashMap = new HashMap<>();
        hashMap.put("vdo_id", "Px-8VyQMJ-g");
        hashMap.put("vdo_title", "যাকাত কাদের উপর ফরজ | যাকাত ফরজ হওয়ার ৫টি শর্ত ।");
        hashMap.put("vdo_desciption", "মিজানুর রহমান আজহারী");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.video_playlist_activity);
        ...
        tvSItemBack.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mainIntent = new Intent(VideoPlaylist.this, MainActivity.class);
                startActivity(mainIntent);
                Toast.makeText(VideoPlaylist.this, "Successfully back to main page!", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        youTubePlayerView.initialize("ABCD", VideoPlaylist.this);
            ...
            public void onClick(View v) {
                ...
                if (v!=null && v.getTag()!=null){
                    ...
                    if (tag.contains("PLAYING")){
                        ...
                        else Toast.makeText(VideoPlaylist.this, "Please wait...", Toast.LENGTH_LONG).show();
    ...
    private void makeListView(){
        ...
        ListView listView = new ListView( VideoPlaylist.this);
        ...
        layoutContainer.startAnimation(AnimationUtils.loadAnimation(VideoPlaylist.this, R.anim.fade_in));
    ...
    private class MyAdapter extends BaseAdapter {
        ...
        public MyAdapter(){
            this.inflater = (LayoutInflater)VideoPlaylist.this.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        }
    ...
    private void playVideo(String video_id){
        ...
        if(myYoutubePlayer!=null){
            ...
            layPlayer.startAnimation(AnimationUtils.loadAnimation(VideoPlaylist.this, R.anim.fade_in));
            myYoutubePlayer.loadVideo(video_id);
            myYoutubePlayer.play();
            playingVideo = true;
        }else{
            Toast.makeText(VideoPlaylist.this, "Please wait...", Toast.LENGTH_LONG).show();
        }
    }
    //================================================
    ...
    private void playPreviousVideo(){
        if(PLAYING_NOW > 0){
            ...
            Toast.makeText(VideoPlaylist.this, "Playing the first video", Toast.LENGTH_LONG).show();
        }
